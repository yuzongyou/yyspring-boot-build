 ...
 */
public class Dbcp2PoolProvider implements PoolProvider {

    private static final PoolType SUPPORT_POOL_TYPE = PoolType.DBCP2;

    private static final String DEFAULT_DS_CLASS = "org.apache.commons.dbcp2.BasicDataSource";
