 ...
 */
public class TMultiplexedBinaryProtocolFactory extends AbstractTProtocolFactory {

    public TMultiplexedBinaryProtocolFactory(Class<?> serviceClass, String router) {
        super(serviceClass, null, router);
    }

    public TMultiplexedBinaryProtocolFactory(Class<?> serviceClass, Set<ClientType> clientTypes, String router) {
        super(serviceClass, clientTypes, router);
    }

    public TMultiplexedBinaryProtocolFactory(Class<?> serviceClass, ClientType clientType, String router) {
    ...
    public TProtocol create(TClientConfig clientConfig, TTransport transport) {
        return new TMultiplexedProtocol(new TBinaryProtocol(transport), router());
    }
}
