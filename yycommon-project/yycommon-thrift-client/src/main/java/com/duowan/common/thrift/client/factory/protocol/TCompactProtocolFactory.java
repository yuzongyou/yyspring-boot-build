 ...
 */
public class TCompactProtocolFactory extends AbstractTProtocolFactory {

    public TCompactProtocolFactory(Class<?> serviceClass) {
        super(serviceClass, null, null);
    }

    public TCompactProtocolFactory(Class<?> serviceClass, Set<ClientType> clientTypes) {
        super(serviceClass, clientTypes, null);
    }

    public TCompactProtocolFactory(Class<?> serviceClass, ClientType clientType) {
