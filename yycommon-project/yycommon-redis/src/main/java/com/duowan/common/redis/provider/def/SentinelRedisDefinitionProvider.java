 ...
 * @author Arvin
 */
public class SentinelRedisDefinitionProvider implements RedisDefinitionProvider {
    @Override
    public boolean support(RedisDefinition redisDefinition) {
        return null != redisDefinition && redisDefinition instanceof SentinelRedisDefinition;
    }
    ...
    public boolean checkAndApplyDefaultConfig(RedisDefinition redisDefinition) {
        ...
        SentinelRedisDefinition sentinelRedisDef = (SentinelRedisDefinition) redisDefinition;
        ...
        AssertUtil.assertNotBlank(sentinelRedisDef.getId(), "RedisDefinition.id 不能为空");
        AssertUtil.assertNotBlank(sentinelRedisDef.getSentinels(), "[" + sentinelRedisDef.getId() + "]RedisDefinition.sentinels 不能为空");
        AssertUtil.assertNotBlank(sentinelRedisDef.getMasterName(), "[" + sentinelRedisDef.getId() + "]RedisDefinition.masterName 不能为空");
     ...
     * 应用默认的连接池配置
     *
     * @param sentinelRedisDef RedisDefinition 定义
     * @return 返回设置了默认连接池之后的配置
     */
    private Map<String, String> applyDefaultPoolConfig(SentinelRedisDefinition sentinelRedisDef) {
