...
public class StdRedisDefinitionProvider implements RedisDefinitionProvider {
    ...
    public boolean checkAndApplyDefaultConfig(RedisDefinition redisDefinition) {
        ...
        AssertUtil.assertNotBlank(stdRedisDef.getId(), "RedisDefinition.id 不能为空");
        AssertUtil.assertNotBlank(stdRedisDef.getServer(), "[" + stdRedisDef.getId() + "]RedisDefinition.server不能为空");
