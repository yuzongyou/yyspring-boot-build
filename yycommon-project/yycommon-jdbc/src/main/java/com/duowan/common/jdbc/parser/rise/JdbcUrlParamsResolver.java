 ...
 * @author Arvin
 */
public class JdbcUrlParamsResolver implements RiseJdbcDefFieldResolver {

    private static final String KEY = "jdbcUrlParams";
    ...
    public boolean resolve(Map<String, String> aliasMap, RiseJdbcDef jdbcDef, String key, String subKey, String value) {
        ...
        if (StringUtils.isNotBlank(value)) {
            jdbcDef.setJdbcUrlParam(value.replaceFirst("\\?+", ""));
        }
